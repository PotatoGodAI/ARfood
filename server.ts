    ...
    try {
      const jsonResponse = await handleUpload({
        ...
        onBeforeGenerateToken: async (pathname, clientPayload) => {
          ...
          // For simplicity, we'll allow it if a userId is provided in the clientPayload
          ...
          return {
            allowedContentTypes: [".glb", ".usdz", ".gltf", "model/gltf-binary", "model/vnd.usdz+zip", "application/octet-stream"],
